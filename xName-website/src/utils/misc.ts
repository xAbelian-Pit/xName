...
export function getChainIdKeys(): string[] {
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
  return Object.keys(ChainId).filter((key: string) => typeof ChainId[key] === 'string')
  // return Object.values(myEnum).filter((key) => typeof key === 'string')
